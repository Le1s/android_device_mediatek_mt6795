...
ifeq ($(strip $(MTK_CHARM_SUPPORT)), yes)
    PRODUCT_PACKAGES += libcharm
    PRODUCT_PACKAGES += libmtkocl
...
# Vanzo:songlixin on: Tue, 20 Jan 2015 11:33:45 +0800
# we will use our global version or customer's version
...
PRODUCT_COPY_FILES += device/mediatek/mt6795/init.ssd_nomuser.rc:root/init.ssd_nomuser.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6795/init.ssd.rc:root/init.ssd.rc
endif
else
PRODUCT_COPY_FILES += device/mediatek/mt6795/init.no_ssd.rc:root/init.no_ssd.rc
endif
...
ifeq ($(strip $(MTK_ANT_SUPPORT)), yes)
      ...
      PRODUCT_COPY_FILES += vendor/mediatek/proprietary/packages/apps/ant-wireless/antradio-library/com.dsi.ant.antradio_library.xml:system/etc/permissions/com.dsi.ant.antradio_library.xml
endif
...
# Vanzo:wangfei on: Sat, 17 Jan 2015 11:47:55 +0800
# added for cross platform packages support
$(call inherit-product, vanzo/cross-platform-packages.mk)
# End of Vanzo:wangfei

# Vanzo:yucheng on: Tue, 27 Jan 2015 13:19:18 +0800
# Added for nvram writing & backup
PRODUCT_PROPERTY_OVERRIDES += ro.nid.productinfo=59 \
